  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-64px)] bg-background py-12 px-4 relative overflow-hidden transition-colors duration-500">
        ...
        <div className="absolute top-10 left-10 w-24 h-24 bg-primary/20 dark:bg-primary/10 -rotate-12 -z-10 blur-2xl" />
        <div className="absolute bottom-10 right-10 w-32 h-32 bg-black/5 dark:bg-white/5 rotate-6 -z-10" />
